class FormationBehavior extends Sup.Behavior {
  awake() {
    ...
    Sup.getActor("MovingPlatform4").getBehavior(MovingPlatformBehavior).direction = true;
    ...
    Sup.getActor("MovingPlatform5").getBehavior(MovingPlatformBehavior).direction = true;
